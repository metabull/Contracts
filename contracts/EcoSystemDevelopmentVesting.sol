...
contract EcoSystemDevelopmentVesting is Ownable {
        ...
        returns (uint256 availablePercentage)
    {
        ...
        uint256 initialCliff = BokkyPooBahsDateTimeLibrary.addDays(
            _initialTimestamp,
            30
        );
        ...
        uint256 noOfRemainingSeconds = uint256(365).mul(86400);

        uint256 everySecondReleasePercentage = remainingDistroPercentage
            .mul(1e18)
            .div(noOfRemainingSeconds);
